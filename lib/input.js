...
const { gap, greeting, signUpPrompts, signInPrompts, crudPrompts, entryFilter, datePrompt, entryList, updateDelete, updatePrompt, categoryPrompt, createPrompt, categoryDatePrompt, journalList, createJournalPrompt } = require('./prompts');
...
module.exports = { greetingMenu, signUp, signOut, startMenu, createEntry, selectFilter, filterCategoryDate, selectCategory, filterDate, getEntries, entryPromptConstructor, listEntries, displayEntry, updateEntry, deleteEntry, postAPI, putAPI, signUpApi, storeToken, signIn, dateHandler, exitHandler };
