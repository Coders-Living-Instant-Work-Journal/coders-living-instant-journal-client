...
const { greeting, signUpPrompts, signInPrompts, crudPrompts, entryFilter, datePrompt, entryList, updateDelete, updatePrompt, categoryPrompt, createPrompt } = require('./prompts');
...
function getCategories() {
  headerHandler();
  console.log(chalk.keyword('orange')('----- SELECT A CATEGORY -----\n'));
